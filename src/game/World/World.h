...
enum eConfigUInt32Values
{
    ...
    //Start Hardcore Defines
    CONFIG_UINT32_HARDCORE_GRAVE_GAMEOBJECT_ID, 
    CONFIG_UINT32_HARDCORE_LOOT_GAMEOBJECT_ID,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_HARDCORE_DROP_MONEY,
    CONFIG_FLOAT_HARDCORE_LEVEL_DOWN,
    //Start Hardcore Defines
